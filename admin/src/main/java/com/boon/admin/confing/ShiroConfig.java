...
import com.boon.admin.filter.LogoutFilter;
import com.boon.admin.filter.RestfulFilter;
import com.boon.admin.security.MyShiroRealm;
...
//        shiroFilterFactoryBean.setLoginUrl("/common/unLogin");

        // 拦截器.
        Map<String, String> filterChainDefinitionMap = new LinkedHashMap<String, String>();

        filterChainDefinitionMap.put("/user/login", "anon");
        filterChainDefinitionMap.put("/user/findBySno/**","anon");
//        filterChainDefinitionMap.put("/user/findAll","anon");
